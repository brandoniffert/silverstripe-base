(function ($) {
  $.entwine("ss", function ($) {
    ...
    window.addEventListener("click", function (e) {
      ...
      const wrapper = target.closest(".iconpickerfield-wrapper");

      if (!wrapper) {
        document.querySelectorAll(".iconpickerfield-wrapper").forEach((x) => x.classList.remove("is-active"));
